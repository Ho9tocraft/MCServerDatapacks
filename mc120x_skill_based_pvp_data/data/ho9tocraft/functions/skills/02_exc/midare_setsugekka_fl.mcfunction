...
execute as @s at @s run tellraw @a ["",{ "bold": false, "italic": false, "translate": "use.midare_setsugekka_fl.name", "fallback": "%1$s used \"Midare Setsugekka: Frenzied Laugher\".", "with": [ { "selector": "@s" }]}]
