...
#region team=RED
execute as @s[team=RED] at @s as @e[team=BLU,distance=..5] at @s run damage @s 12.5 minecraft:player_attack by @a[team=RED,tag=OffWS_Exec,limit=1]
#endregion
#region team=BLU
execute as @s[team=BLU] at @s as @e[team=RED,distance=..5] at @s run damage @s 12.5 minecraft:player_attack by @a[team=BLU,tag=OffWS_Exec,limit=1]
#endregion
#region PostProcess
# Particles
...
execute as @s[tag=OffWS_Exec] at @s run tag @s remove OffWS_Exec
#endregion
