...
#region team=RED
execute as @s[team=RED] at @s as @e[team=BLU,distance=..3,sort=nearest,limit=1] at @s run damage @s 69.3 player_attack by @a[team=RED,tag=Senei_Exec,sort=nearest,limit=1]
#endregion
#region team=BLU
execute as @s[team=BLU] at @s as @e[team=RED,distance=..3,sort=nearest,limit=1] at @s run damage @s 69.3 player_attack by @a[team=BLU,tag=Senei_Exec,sort=nearest,limit=1]
#endregion
#region PostProcess
# Particles
