...
execute as @s at @s run tellraw @a ["",{ "bold": false, "italic": false, "translate": "use.tenka_goken_.name", "fallback": "%1$s used \"Tenka Goken: Binary Star\".", "with": [ { "selector": "@s" }]}]
...
#endregion
#region team=BLU
execute as @s[team=BLU] at @s as @e[team=RED,distance=..8] at @s run damage @s 74.25 player_attack by @a[team=BLU,tag=Goken_Exec,sort=nearest,limit=1] from @a[team=BLU,tag=Goken_Exec,sort=nearest,limit=1]
#endregion
#region PostProcess
# Particles
# Additional Effect
