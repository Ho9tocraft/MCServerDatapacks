...
execute as @s at @s run tellraw @a ["",{ "bold": false, "italic": false, "translate": "use.exorcist_lb.name", "fallback": "%1$s used \"Retribution Panish of the Heavens\".", "with": [ { "selector": "@s" }]}]
tag @s add LB_Exec
