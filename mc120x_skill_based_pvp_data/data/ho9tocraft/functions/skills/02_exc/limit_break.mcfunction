...
tag @s add LB_Exec
#region team=RED
execute as @s[team=RED] at @s as @e[team=BLU,distance=..6] at @s run damage @s 97.35 player_attack by @a[team=RED,tag=LB_Exec,limit=1]
#endregion
#region team=BLU
execute as @s[team=BLU] at @s as @e[team=RED,distance=..6] at @s run damage @s 97.35 player_attack by @a[team=BLU,tag=LB_Exec,limit=1]
#endregion
#region PostProcess
