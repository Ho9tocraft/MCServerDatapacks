...
execute as @s[team=RED] at @s as @e[tag=BoV_TarBLU,distance=..25,sort=nearest,limit=1] at @s run particle dust_color_transition{from_color:[0.855,0.647,0.125],scale:1,to_color:[1.000,0.843,0.000]} ~ ~ ~ 5 10 5 1 750 normal @a[distance=..30]
...
execute as @s[team=BLU] at @s as @e[tag=BoV_TarRED,distance=..25,sort=nearest,limit=1] at @s run particle dust_color_transition{from_color:[0.855,0.647,0.125],scale:1,to_color:[1.000,0.843,0.000]} ~ ~ ~ 5 10 5 1 750 normal @a[distance=..30]
