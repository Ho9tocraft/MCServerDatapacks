...
# RED -> BLU
execute as @s[team=RED] at @s as @e[team=BLU,distance=..25,sort=nearest,limit=1] at @s run damage @s 16.0 indirect_magic by @a[team=RED,tag=GlareIII_Exec,limit=1]
execute as @s[team=RED] at @s as @e[team=BLU,distance=..25,sort=nearest,limit=1] at @s run effect clear @s haste
# BLU -> RED
execute as @s[team=BLU] at @s as @e[team=RED,distance=..25,sort=nearest,limit=1] at @s run damage @s 16.0 indirect_magic by @a[team=BLU,tag=GlareIII_Exec,limit=1]
execute as @s[team=BLU] at @s as @e[team=RED,distance=..25,sort=nearest,limit=1] at @s run effect clear @s haste
...
execute as @s at @s run tag @s remove GlareIII_Exec
