...
execute as @s[team=RED] at @s if score @s CAST_TIMER matches 0 as @e[team=BLU,distance=..25,sort=nearest,limit=1] at @s run damage @s 48.0 indirect_magic by @a[team=RED,tag=BroilII_Exec,limit=1]
...
execute as @s[team=BLU] at @s if score @s CAST_TIMER matches 0 as @e[team=RED,distance=..25,sort=nearest,limit=1] at @s run damage @s 48.0 indirect_magic by @a[team=BLU,tag=BroilII_Exec,limit=1]
