#Verthunder III(ヴァルサンダガ)

execute as @s at @s run tellraw @a ["",{ "bold": false, "italic": false, "translate": "cast.veraero_iii.name", "fallback": "%1$s is the \"Verthunder III\" stance.", "with": [ { "selector": "@s" }]}]
