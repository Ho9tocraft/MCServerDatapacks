#Jolt II(ジョルラ)
#define tag Red_Magic_Cast

execute as @s at @s run tellraw @a ["",{ "bold": false, "italic": false, "translate": "cast.jolt_ii.name", "fallback": "%1$s is the \"Jolt II\" stance.", "with": [ { "selector": "@s" }]}]
