...
#region team=RED
execute as @s[team=RED] at @s if score @s CAST_TIMER matches 0 as @e[team=BLU,distance=..25,sort=nearest,limit=1] at @s run particle dust_color_transition{from_color:[0.278,0.149,0.431],scale:1,to_color:[0.518,0.102,0.459]} ~ ~ ~ 0.6 3.5 0.6 1 750 normal @a[distance=..30]
...
#endregion
#region team=BLU
execute as @s[team=BLU] at @s if score @s CAST_TIMER matches 0 as @e[team=RED,distance=..25,sort=nearest,limit=1] at @s run particle dust_color_transition{from_color:[0.278,0.149,0.431],scale:1,to_color:[0.518,0.102,0.459]} ~ ~ ~ 0.6 3.5 0.6 1 750 normal @a[distance=..30]
