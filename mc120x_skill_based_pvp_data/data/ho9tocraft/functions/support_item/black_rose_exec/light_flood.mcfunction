...
# LIGHTFLOOD DEATH
execute as @e[type=!villager,tag=BRose_EFFECT] at @s if score ^VPHandler TICK_ROOP matches 3 if predicate ho9tocraft:random_controller/rand_1_3 run scoreboard players add @s DEATH_TIMER 20
execute as @e[type=!villager,tag=BRose_EFFECT] at @s if score ^VPHandler TICK_ROOP matches 8 if predicate ho9tocraft:random_controller/rand_1_3 run scoreboard players add @s DEATH_TIMER 20
execute as @e[type=!villager,tag=BRose_EFFECT] at @s if score ^VPHandler TICK_ROOP matches 13 if predicate ho9tocraft:random_controller/rand_1_3 run scoreboard players add @s DEATH_TIMER 20
execute as @e[type=!villager,tag=BRose_EFFECT] at @s if score ^VPHandler TICK_ROOP matches 18 if predicate ho9tocraft:random_controller/rand_1_3 run scoreboard players add @s DEATH_TIMER 20
