...
execute as @e[type=!villager,tag=BRose_EFFECT,team=!Spectate] at @s if score @s DEATH_TIMER matches 600.. run damage @s 2147483647 ho9tocraft:ngeffect/death by @a[tag=BRose_Exec,limit=1]
