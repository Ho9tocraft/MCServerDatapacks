...
execute as @s at @s as @e[type=!villager] at @s run tag @s add BRose_EFFECT
execute as @s at @s as @e[type=!villager] at @s run scoreboard players set @s MAX_MP 0
execute as @s at @s as @e[type=!villager] at @s run scoreboard players set @s PROC_TIMER_AB 0
execute as @s at @s as @e[type=!villager] at @s run scoreboard players set @s PROC_TIMER_MG 0
execute as @s at @s as @e[type=!villager] at @s run scoreboard players set @s PROC_TIMER_WS 0
execute as @s at @s as @e[type=!villager] at @s run scoreboard players set @s AB_RECAST_T 2147483647
