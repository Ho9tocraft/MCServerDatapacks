...
execute if score ^VPHandler BATTLE_COND matches 1 if score ^VPHandler BATTLE_TIMER matches 1.. if score ^VPHandler B_SPL_CLC matches 0 if predicate ho9tocraft:random_controller/rand_3_100 run function ho9tocraft:battle/process/eighth_umbral_era/the_eighth_umbral_era
